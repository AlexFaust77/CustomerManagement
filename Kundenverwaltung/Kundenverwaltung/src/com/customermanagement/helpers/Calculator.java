...
public class Calculator {
	    ...
	    private ArrayList<String> lst_month = new ArrayList<String>();				 // vorher monat ------ outdated
	    ...
	    //FXML List
	    private ArrayList<String> month = new ArrayList<String>();					 // prepared Month for Rates
...
/// => FXML Form - prepare a list with Month for the Rates	    
// -> old - > > > public void fillMonth(MainGuiController mainGuiController,SQL_Statements dataBase_Request,Logger logger ) {
public void fillMonth(Logger logger ) {
	    	Date date = new Date();							
	    	int current_month;		
	    	int current_year;		
	    	...
	    	// fill lists for 48 rates
	    	for(int monthCounter = 0; monthCounter < 48;monthCounter++) {

	    		month.add(current_month + "/" + current_year);
	    		logger.debug("Current Month : " + current_month + "\nCurrent Year : " + current_year);  
	 ...
	 // FXML Form
	 public void getAllRates(Logger logger, ObservableList<Obj_Order> orders) {     
		    double allreadyPaid = 0;
		    double stillToPay = 0;
	 ...
	 private void convert_double_to_string(Double[] monthly_rates) {
	    ...
	    public ArrayList<String> getLstMonth(){ return lst_month; }   // outdated
	    public void setLstMonth(ArrayList<String> lst_month) { this.lst_month = lst_month; } // outdated
		...
		// for FXML Form
		public ArrayList<String> getMonth(){ return month; }
